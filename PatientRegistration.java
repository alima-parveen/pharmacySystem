...
public class PatientRegistration extends JFrame implements ActionListener{
    ...
    JLabel l1,l3,l4,l5,l6,l7,l8,l9,l11,l13,l14,l15,heading, patient_id;
    ...
    PatientRegistration(){
        ...
        add(l11);
       //heaading 
        patient_id = new JLabel("Patient ID" );
        patient_id.setBounds(200,50,400,45);
        patient_id.setFont(new Font("Raleway", Font.BOLD, 38));
        patient_id.setForeground(new Color(139, 69, 19));
        add(patient_id);
        
        l1 = new JLabel("P_ID-"+first);
        l1.setFont(new Font("Raleway", Font.BOLD, 38));
        l1.setForeground(new Color(139, 69, 19));
        l1.setBounds(400,50,250,45);
        add(l1);
