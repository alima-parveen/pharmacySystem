...
public class PatientDelete extends JFrame implements ActionListener{
    
    JLabel l1,l3,l4,l5,l6,l7,l8,l9,l13,l14,l15,heading, t1, t2, ldateShow, dateChooser, t3,t4,t5;;
    JLabel r1,r2;
	...
	dateChooser.setForeground(new Color(105, 105, 105));
      ...
      //submit button
        delete.setBounds(250,550,120,30);
    ...
    if (ae.getSource() == delete) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Check if dateChooser is not null before setting text
                if (dateChooser != null) {
                    dateChooser.setText(rs.getString("dob"));
                }
                ...
                // Continue with the rest of the code for deleting records
                // First, delete related records from prescription table
                            // First, delete related records from billing table
            String billingQuery = "delete from billing where p_id='" + p_id + "'";
            c.s.executeUpdate(billingQuery);
                String prescriptionQuery = "delete from prescription where p_id='" + p_id + "'";
                c.s.executeUpdate(prescriptionQuery);
...
//                c.s.executeUpdate(billingQuery);
                ...
                String patientQuery = "delete from patient where p_id='" + p_id + "'";
                c.s.executeUpdate(patientQuery);

                JOptionPane.showMessageDialog(null, "Patient, related billing records, and prescriptions deleted Successfully");
                setVisible(false); // Close the window after successful deletion
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
